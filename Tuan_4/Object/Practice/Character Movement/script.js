class Hero {
    ...
    getHeroElementRight() {
        return '<img width="'+ this.size + '"' +
            ' height="'+ this.size + '"' +
            ' src="' + this.image +'"' +
            ' style="top: '+this.up+'px; left:'+this.left+'px;position:absolute;"  alt=""/>';
    }
    ...
    getHeroElementLeft() {
        return '<img width="'+ this.size + '"' +
            ' height="'+ this.size + '"' +
            ' src="' + this.image +'"' +
            ' style="top: '+this.up+'px; left:'+this.right+'px;position:absolute;"  alt=""/>';
    }
    ...
    getHeroElementUp() {
        return '<img width="'+ this.size + '"' +
            ' height="'+ this.size + '"' +
            ' src="' + this.image +'"' +
            ' style="top: '+this.down+'px; left:'+this.right+'px;position:absolute;"  alt=""/>';
    }
...
let hero = new Hero('KREA-Exaidmuteki.png',20,100,30,30,1700,700,200);
